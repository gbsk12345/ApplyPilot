...
if __name__ == "__main__":
    # --- Using your specified cookie file name by default ---
    ...
    # --- FIXED: Load cookies once at the beginning to establish a session ---
    ...
    for i, url in enumerate(job_urls):
        ...
        # This script now relies on the initial cookie load.
        # Your working script re-loaded cookies for every URL, which is also a valid (though slower) strategy.
        # This version keeps the more efficient single-load approach.
