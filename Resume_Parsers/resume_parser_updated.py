...
TECHNICAL_SKILLS_LIST = [
    ...
    'accounting software',
    'accounts payable workflow systems',
    'accurev scm',
    'aceproject',
    ...
    'amazon web services',
    'amazon workspaces',
    'americas labor market information systems',
    'amfphp',
    'amigabasic',
    'amplifyjs',
    'ampps',
    ...
    'anvato',
    'anylogic',
    'anything relationship management (xrm) software',
    'apache 1.3',
    'apache accumulo',
    'apache activemq',
    'apache airflow',
    ...
    'availity (health information system)',
    'avalanche (avax)',
    ...
    'costar real estate manager (saas)',
    'coaxpress',
    'cobian backup',
    'cobranet',
    'cockroachdb',
    ...
    'cublas',
    'cucumber (software)',
    'cucumber.js (javascript library)',
    'cudnn',
    'cursor ai',
    'custom post types',
    'custom software',
    ...
    'ecocyc',
    'ecoscope',
    'ecosys (project management software)',
    'ecore',
    ...
    'electron packager',
    'electron.js (javascript library)',
    ...
    'epic adt',
    'epic asap',
    'epic anesthesia (software)',
    'epic beacon (software)',
    'epic beaker',
    'epic bridges',
    'epic cadence (software)',
    'epic clarity',
    'epic emr',
    'epic mychart',
    'epic optime',
    ...
    'firewalld',
    'firmware',
    'firststrike (financial software)',
    'fisheye (software)',
    'fitnesse',
    'five9',
    'flash',
    ...
    'httrack',
    'hackerone',
    'hacklang (programming language)',
    'hadoop cloudera',
    'hadoop distributed file system (hdfs)',
    'hadoop2',
    'hamcrest',
    'hammer.js (javascript library)',
    'hammermill',
    'hamming code',
    'hanami',
    'handheld device markup language',
    'handlebars.js (javascript library)',
    'hangfire',
    'hapi.js (javascript library)',
    'hardlink',
    ...
    'icarus verilog',
    'icewarp mail server',
    'icenium (software development platform)',
    'icepdf',
    'icinga',
    'icinga2',
    'iconv',
    ...
    'imgur',
    'immunix',
    'immutable.js (javascript library)',
    'impact.js (javascript library)',
    'impdp',
    'imperva',
    'impex',
    'impresscms',
    ...
    'insight hub',
    'insight squared',
    'insightvm (vulnerability scanning software)',
    'insitevr',
    'instalod',
    'installanywhere',
    'installjammer',
    ...
    'interroll',
    'intersystems cache',
    'intersystems ensemble data integration platform',
    'intranet portal',
    'intraweb',
    'intrushield',
    'invenio',
    ...
    'laserfiche (content management platform)',
    ...
    'marionette.js (javascript library)',
    'markdown',
    ...
    'mediawiki',
    'median',
    'mediant amisys advance',
    'mediant xcelys staffing',
    'mediator pattern',
    ...
    'microsoft sql server 2016 (sql2016)',
    ...
    'multikey',
    'multimodal models',
    'multipeer connectivity (software)',
    'multiuser dos',
    'mumble',
    'munin (software)',
    'mura cms',
    ...
    'nielsen netview',
    'nielsen soundscan',
    'nightwatch.js (javascript library)',
    'nikto web scanner',
    'nimsoft',
    'ninject',
    'nintex workflow',
    ...
    'openhire (recruiting software)',
    'openid',
    'openldap',
    'openlayers',
    'openlink endur (software)',
    ...
    'ptv vistro (traffic analysis software)',
    'ptv visum (traffic analysis software)',
    ...
    'package.json (javascript library)',
    'packet generators',
    'packeteer',
    'paddlepaddle',
    ...
    'passport.js (javascript library)',
    'password generator',
    'password safe',
    ...
    'proterm',
    'proc format',
    'processing.js (javascript library)',
    ...
    'python server pages (python package)',
    ...
    'red hat satellite',
    'red5',
    'redhat pam (process automation manager)',
    'redactor',
    'redbooth',
    'redcarpet',
    'redgate',
    ...
    'scientificpython (python package)',
    'sciforma',
    ...
    'simplelegal (legal operations software)',
    'simpletext',
    'simpletest',
    'simply accounting',
    'simscape',
    ...
    'spectrum address validation software',
    ...
    'synfig',
    'synon/2e',
    'synopsys primetime (sta software)',
    'synopsys vcs',
    'syntaxnet',
    'syntext serna',
    'synthesio',
    ...
    'triplestore',
    'trixbox',
    'troux (enterprise architecture software)',
    'tru64 unix',
    'true basic',
    ...
    'zeroheight (software)',
    'zerto',
    'zetta (radio automation software)',
