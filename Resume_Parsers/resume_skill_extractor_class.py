...
class ResumeSkillExtractor:
    ...
    def compile_skill_patterns(self):
        for skill in self.skill_list:
            if " " in skill or "." in skill or "#" in skill or "+" in skill or "-" in skill:
                self.compiled_patterns.append(re.compile(r"\b" + re.escape(skill) + r"\b", re.IGNORECASE))
            else:
    ...
    def extract_skills_from_text(self, text):
        ...
        found_skills.update([skill for skill in self.single_word_skills if skill in words])
